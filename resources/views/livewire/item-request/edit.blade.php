    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Supply Request</h1>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Update the details of your supply request</p>
                </div>
                <div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            <form wire:submit.prevent="update" class="p-6 space-y-6">
                            ...
                            <div class="overflow-y-auto max-h-48">
                                <template x-for="item in filteredItems" :key="item.id">
                                    <button type="button" @click="selectItem(item.id)"
                                        ...
                                        <div class="text-sm text-gray-500 dark:text-gray-400 mt-0.5" x-text="item.farm_name"></div>
                                    </button>
                                </template>
                                <div x-show="filteredItems.length === 0" class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">
                                    No items found
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <div class="flex items-baseline mt-1">
                                <span class="text-2xl font-bold text-blue-900 dark:text-white">{{ $selectedItemStock['current_stock'] ?? 0 }}</span>
                                <span class="ml-2 text-sm text-blue-700 dark:text-blue-300">{{ $selectedItemStock['unit'] ?? 'units' }}</span>
                            </div>
                        </div>
                ...
                <div class="p-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg">
                    <p class="text-sm text-gray-600 dark:text-gray-400">Loading stock information...</p>
                </div>
                @endif
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <input type="number" wire:model="quantity" id="quantity" step="1" min="1" 
                            class="block w-full rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-green-500 focus:border-green-500 sm:text-sm px-3 py-2"
                ...
                <div class="space-y-2">
                    ...
                    <textarea wire:model="notes" id="notes" rows="4"
                        class="block w-full rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-green-500 focus:border-green-500 sm:text-sm px-3 py-2"
                        placeholder="Add any special instructions or details...">{{ $notes }}</textarea>
                    @error('notes') 
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">
                            {{ $message }}
                        </p> 
                ...
                <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <button type="button" 
                        ...
                        class="px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                        Cancel
                    </button>
                    <button type="submit" 
                        class="inline-flex items-center px-4 py-2.5 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
