<div x-data="{
    ...
    <div class="max-w-7xl mx-auto">
        ...
        @if (session()->has('success'))
            <div class="mb-6 p-4 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg text-sm">
        ...
        @if (session()->has('error'))
            <div class="mb-6 p-4 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg text-sm">
                <div class="flex items-center">
        ...
        <!-- Filters -->
        <div class="mb-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 border border-gray-200 dark:border-gray-700">
        ...
        <div class="grid grid-cols-1 gap-4">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow">
                    <div class="p-5">
                        <div class="flex justify-between items-start">
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ $request->item_name }}</h3>
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ $request->description ?? 'No description provided' }}</p>
                            </div>
                            <span class="{{ 
            ...
            @empty
                <div class="col-span-full text-center py-12">
                    ...
                    @if(request('search') || (request('status') && request('status') !== 'all'))
                        <div class="mt-6">
                            <a href="{{ route('item-requests.index') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                Clear filters
                            </a>
                        </div>
                    @endif
