...
class ActivityPolicy
{
    ...
    {
        return $user->can('restore_custom::activity::log');
    }
    ...
    {
        return $user->can('restore_any_custom::activity::log');
    }
    ...
    {
        return $user->can('replicate_custom::activity::log');
    }
    ...
    {
        return $user->can('reorder_custom::activity::log');
    }
}
